...
export class HandleStartUpBuildFabricaUseCase implements OnModuleInit {
    ...
    async instanceFirtsFactoryEver(): Promise<void> {
        try {
            ...
            const fabricaJaCriada = await this.fabricaservice.consultaFabricaPrincipal();
            ...
            throw new Error(`Problema ao instanciar o serviço pela primeira vez: ${error.message}`);
        }
    }
