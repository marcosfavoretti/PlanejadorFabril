...
export class RealocaPedidoTodoService
    ...
    protected async realocacao(
        ...
        Logger.log('Planejamento do setor', planejamentosImpactadoDoSetorASC.map(a => a.dia))
        ...
        console.log('ficou adicionado', resultado.adicionado.map(a => a.dia));
        return resultado;
    }

    protected realocacaoComDepedencia(props: RealocacaoComDepedenciaProps): Promise<RealocacaoParcial> {
