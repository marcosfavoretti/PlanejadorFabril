...
import { MercadoLogStoreService } from "@libs/lib/modules/planejamento/@core/services/MercadoLogStore.service";

// Mock da classe Calendario
jest.mock("@libs/lib/modules/shared/@core/classes/Calendario', () => {
    return {
