...
import { ConsultaTabelaDiariaUseCase } from '@libs/lib/modules/planejamento/application/ConsultaTabelaDiaria.usecase';
...
import { SaveTabelaDiarioUseCase } from '@libs/lib/modules/planejamento/application/SaveTabelaDiario.usecase';
import { SalvarTabelaProducaoDiarioDTO } from '@dto/SalvarTabelaProucaoDiario.dto';
import { ConsultarMercadoUseCase } from '@libs/lib/modules/kpi/application/ConsultarMercado.usecase';
...
export class ProducaoSimulacaoController {
  @Inject(ConsultaTabelaDiariaUseCase)
  private generateTabela: ConsultaTabelaDiariaUseCase;
  @Get('/gen')
  @ApiOperation({
  ...
  @ApiResponse({
    ...
    type: () => GetTabelaProducaoDiarioDTO,
    isArray: true,
  })
  async genTabelaDiariaMethod(
    @Query('startDate') start: string,
    @Query('endDate') end: string,
  ): Promise<GetTabelaProducaoDiarioDTO[]> {
  ...
  async saveTabelaDiariaMethod(
    @Body() dto: SalvarTabelaProducaoDiarioDTO,
  ): Promise<void> {
