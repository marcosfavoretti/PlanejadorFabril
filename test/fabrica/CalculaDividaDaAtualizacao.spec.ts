...
describe("CalculaDividaDaAtualizacao", () => {
    ...
    it("should calculate the correct divida when qtd decreases", () => {
        const service = new CalculaDividaDaAtualizacao({
            planejamentoOrigial: { ...planejamentoOrigial, qtd: 20 } as unknown as Planejamento,
            planejamentoNovo: { ...planejamentoNovo, qtd: 10 } as unknown as Planejamento,
            fabrica,
            pedido,
    ...
    it("should use the correct setor from planejamentoOrigial", () => {
        const service = new CalculaDividaDaAtualizacao({
            planejamentoOrigial: { ...planejamentoOrigial, setor: "Setor B" } as unknown as Planejamento,
            planejamentoNovo,
            fabrica,
            pedido,
