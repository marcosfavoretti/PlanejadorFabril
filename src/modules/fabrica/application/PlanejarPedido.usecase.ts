...
import { PlanejarPedidoDTO } from "src/delivery/dtos/PlanejarPedido.dto";
...
export class PlanejarPedidoUseCase {
    ...
    async planeje(dto: PlanejarPedidoDTO): Promise<void> {
        try {
            ...
            const user = await this.userService.systemAuth();//quero que todas as fabrica main fiquem no admin por hora
