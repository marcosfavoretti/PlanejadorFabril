...
import { ConsultarPedidosDTO, TIPO_CONSULTA } from "src/delivery/dtos/ConsultarPedidos.dto";
import { PedidoResponseDTO } from "src/delivery/dtos/PedidoResponse.dto";
